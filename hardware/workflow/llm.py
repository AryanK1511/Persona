...
class LLM:
    ...
    def generate_response(self, user_prompt: str, intent: str, data: str) -> str:
        ...
        if intent == "general":
            ...
            system_message = (
                "Just answer this current location question with the given data " + data
            )
        elif intent == "distance":
            system_message = (
                "Just answer this distance question with the given data " + data
            )
            ...
            system_message = (
                "Today is "
                + now
                + " Answer the schedule question with the following schedule "
                + data
            )
            ...
            system_message = (
                "Just paraphrase this schedule permission request response."
            )
        if DEBUGGING_FLAG:
